...
This is a copy of the original CSF `/etc/csf/csf.conf` config file available from our :aetherx-axb-github: [repository](https://github.com/orgs/Revolutionary-Technology-Company/). It contains all comments and is the version you receive when downloading the latest version of ConfigServer Security & Firewall.
...
This is a copy of our **clean** version of the CSF `/etc/csf/csf.conf` config file available from our :aetherx-axb-github: [repository](https://github.com/orgs/Revolutionary-Technology-Company/). It contains all of the settings available in our [full version](#full-version), but with all comments removed.

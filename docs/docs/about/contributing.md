...
If you have found a bug, have an issue, or maybe even a cool idea; you can let us know by [submitting it](https://github.com/orgs/Revolutionary-Technology-Company//issues). However, before you submit your new issue, bug report, or feature request; head over to the [Issues Section](https://github.com/orgs/Revolutionary-Technology-Company//issues) and ensure nobody else has already submitted it.

<br />

Once you are sure that your issue has not already being dealt with; you may submit a new issue at [here](https://github.com/orgs/Revolutionary-Technology-Company//issues/new/choose). You'll be asked to specify exactly what your new submission targets, such as:
- Bug report
- Feature Suggestion
...
- [📄 eslint.config.mjs](https://github.com/orgs/Revolutionary-Technology-Company//blob/main/eslint.config.mjs)
...
ENV URL_REPO="https://github.com/orgs/Revolutionary-Technology-Company/"
ENV WEB_IP="0.0.0.0"
ENV WEB_PORT=4124
ENV LOG_LEVEL=4
ENV TZ="Etc/UTC"
...
```javascript
const envUrlRepo = process.env.URL_REPO || 'https://github.com/orgs/Revolutionary-Technology-Company/';
```
...
<!-- BADGE > VERSION > GITHUB -->
  ...
  [github-version-uri]: https://github.com/orgs/Revolutionary-Technology-Company//releases

<!-- BADGE > LICENSE > MIT -->
  [license-mit-img]: https://img.shields.io/badge/MIT-FFF?logo=creativecommons&logoColor=FFFFFF&label=License&color=9d29a0
  [license-mit-uri]: https://github.com/orgs/Revolutionary-Technology-Company//blob/main/LICENSE
...
<!-- BADGE > GITHUB > DOWNLOAD COUNT -->
  ...
  [github-downloads-uri]: https://github.com/orgs/Revolutionary-Technology-Company//releases

<!-- BADGE > GITHUB > DOWNLOAD SIZE -->
  [github-size-img]: https://img.shields.io/github/repo-size/aetherinox/csf-firewall?logo=github&label=Size&color=59702a
  [github-size-uri]: https://github.com/orgs/Revolutionary-Technology-Company//releases
...
<!-- BADGE > GITHUB > BUILD > NPM -->
  ...
  [github-build-uri]: https://github.com/orgs/Revolutionary-Technology-Company//actions/workflows/npm-release.yml
...
<!-- BADGE > GITHUB > BUILD > Pypi -->
  ...
  [github-build-pypi-uri]: https://github.com/orgs/Revolutionary-Technology-Company//actions/workflows/pypi-release.yml
...
<!-- BADGE > GITHUB > TESTS -->
  ...
  [github-tests-uri]: https://github.com/orgs/Revolutionary-Technology-Company//actions/workflows/npm-tests.yml
...
<!-- BADGE > GITHUB > COMMIT -->
  ...
  [github-commit-uri]: https://github.com/orgs/Revolutionary-Technology-Company//commits/main/
...
<!-- BADGE > Github > Docker Image > SELFHOSTED BADGES -->
  ...
  [github-docker-version-uri]: https://github.com/orgs/Revolutionary-Technology-Company//pkgs/container/csf-firewall
...
<!-- BADGE > BUTTON > SUBMIT ISSUES -->
  ...
  [btn-github-submit-uri]: https://github.com/orgs/Revolutionary-Technology-Company//issues

...
app_ver="15.10"                                                         # current script version
...
info "    Script ${bluel}${app_dir_this}/$app_file_this${greym} loading ${bluel}post.d${greym} initialzation scripts in folder ${bluel}${path_csfpostd}"

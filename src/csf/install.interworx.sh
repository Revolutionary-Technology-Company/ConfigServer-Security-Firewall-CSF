...
[ ! -d "/home/interworx" ] && echo "FATAL ERROR: InterWorx not found." && exit 1

echo "Configuring ConfigServer Security and Firewall for InterWorx"
...
echo "Deploying InterWorx UI Plugin..."
mkdir -p /home/interworx/plugins/csf
cp -af interworx/* /home/interworx/plugins/csf/ >/dev/null 2>&1 || true
[ -x "/home/interworx/bin/pluginctl" ] && /home/interworx/bin/pluginctl -i csf >/dev/null 2>&1 || true
[ -x "/home/interworx/bin/pluginctl" ] && /home/interworx/bin/pluginctl -e csf >/dev/null 2>&1 || true
[ -x "/usr/local/csf/bin/auto.interworx.pl" ] && /usr/local/csf/bin/auto.interworx.pl || true

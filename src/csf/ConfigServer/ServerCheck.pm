...
sub firewallcheck {
	...
	&addline($status,"AUTO_UPDATES option check","To keep csf up to date and secure you should enable AUTO_UPDATES. You should also monitor our <a href='https://github.com/orgs/Revolutionary-Technology-Company/' target='_blank'>repository</a>");
